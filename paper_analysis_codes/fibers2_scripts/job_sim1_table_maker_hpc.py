...
def main(argv):
    ...
    master_summary = writepath+baseline_experiment+'/'+dataset_folder_names[0]+'/summary/'+dataset_folder_names[0]+'_master_summary.csv'
    summary = writepath+baseline_experiment+'/'+dataset_folder_names[0]+'/summary/'+dataset_folder_names[0]+'_summary.csv'
