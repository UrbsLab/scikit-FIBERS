...
logs_dir = '/project/kamoun_shared/output_shared/bandheyh/FIBERS-summer/multi/logs'
scratch_dir = '/project/kamoun_shared/output_shared/bandheyh/FIBERS-summer/multi/scratch'
