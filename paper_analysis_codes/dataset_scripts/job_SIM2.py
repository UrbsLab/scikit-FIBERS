...
from src.skfibers.simulators.SIM2 import survival_data_simulation_covariates #SOURCE CODE RUN
...
def main(argv):
    ...
    _, data = survival_data_simulation_covariates(instances=instance,total_features=total_feature,predictive_features=pred_feature,
                                                  low_risk_proportion = 0.5,threshold=threshold,feature_frequency_range=(0.1, 0.4),
                                                  noise_frequency=noise,censoring_frequency=censor,negative_control=nc,random_seed=42)
