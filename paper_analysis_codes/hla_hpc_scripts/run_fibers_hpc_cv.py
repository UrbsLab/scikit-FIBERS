    ...
    for part in range(1, cv+1):
        ...
        if run_cluster == 'LSF':
            submit_lsf_cluster_job(scratchPath,logPath,datafolder,outputpath,part,manual_bin_init,reserved_memory,queue,outcome_label,outcome_type,
                                    ...
                                    group_strata_min,penalty,group_thresh,min_thresh,max_thresh,thresh_evolve_prob,desired_bin_effect,pop_clean,loci_list,cov_list,rare_filter,random_seed)
            jobCount +=1
