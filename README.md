...
![alttext](https://github.com/UrbsLab/scikit-FIBERS/tree/dev/Pictures/FIBERS2.0_paper_vertical_color.png?raw=true)
...
| -------------- | ----------- | ------------- |
| outcome_label | Data column label for time-to-event (outcome) | "Duration" |
