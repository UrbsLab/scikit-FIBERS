...
| group_thresh | Optionally specify a group threshold for bins to use | int | None |
...
| log_rank_weightning | Optional weighting of log-rank test | None, 'wilcoxon', 'tarone-ware', 'peto', 'fleming-harrington' | None |
...
| pop_clean | Optional bin population cleanup strategy | None, 'group_strata' | None |
