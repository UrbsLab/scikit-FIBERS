...
def test_fibers():
    ...
    fibers_obj = FIBERS(given_starting_point=False, amino_acid_start_point=None,
                        amino_acid_bins_start_point=None, iterations=100, label_name="grf_fail",
                        duration_name="graftyrs",
                        set_number_of_bins=50, min_features_per_group=5,
                        max_number_of_groups_with_feature=25, crossover_probability=0.8,
