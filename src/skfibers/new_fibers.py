...
from .methods.new_algorithms import fibers_algorithm
...
class FIBERS(BaseEstimator, TransformerMixin):
    def __init__(self, label_name="Class", duration_name="Duration",
                 ...
                 min_threshold = 0, max_threshold = 3, merge_probability = 0.0,covariates = [], scoring_method = "log_rank", threshold = "no"):
        """
